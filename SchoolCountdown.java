...
public class SchoolCountdown
{
	...
	public static enum Holiday implements Comparable<Holiday>
	{
		// all of the holidays
    ...
    public static String[] generateMessages( Holiday earliest , Holiday summer )
    {
		...
		if( untilSummer[0] <= 90 )
			String tooltip = ( untilClosest[1] > 12 ? untilClosest[0]+1: untilClosest[0]) + " day" + (untilClosest[0]==1 ? "":"s" ) + " until the closest holiday!";
		else String tooltip = (String)summerResults[2];
